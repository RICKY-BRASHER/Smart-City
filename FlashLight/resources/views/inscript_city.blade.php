...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ── Brand panel ── */
        .brand-panel {
            background: linear-gradient(155deg,rgb(26, 219, 203) 0%, #1344B8 55%,rgb(59, 175, 183) 100%);
            padding: 52px 44px;
...
<div class="auth-wrapper">
    ...
    <div class="form-panel">
        ...
        <div class="form-header">
            ...
            <p>Rejoignez Smart-City et faites la différence dans votre ville</p>
        </div>
        ...
        <form id="registerForm" novalidate>
            ...
            <!-- Submit -->
            <div class="btn-row">
                <button type="bouton" class="btn-cf-primary" id="submitBtn">
        ...
        <div class="form-footer">
            ...
            <a href="{{ route('connexion') }}">Connectez-vous</a>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#submitBtn').click(function(e) {
            ...
            // On vide les erreurs précédentes et on remet le style par défaut
            $('.invalid-feedback-cf').remove(); 
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.success){
                        $('#btnText').text('Compte créé ! Verification en cours...');
                        $('#btnSpinner').addClass('d-none');
                        // Redirection après un court délai pour laisser le temps à l'utilisateur de voir le message
                        setTimeout(function() {
                ...
                error: function(xhr) {
                    ...
                    btnSpinner.addClass('d-none');
                    btnText.text('Créer mon compte');

                    if (xhr.status === 422) {
                        let errors = xhr.responseJSON.errors;
                        
                        // On boucle sur chaque erreur renvoyée par Laravel
